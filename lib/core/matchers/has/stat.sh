...
shellspec_syntax_alias 'shellspec_matcher_have_setgid' 'shellspec_matcher_has_setgid'
shellspec_syntax 'shellspec_matcher_has_setuid'
shellspec_syntax_alias 'shellspec_matcher_have_setuid' 'shellspec_matcher_has_setuid'
...
shellspec_matcher_has_setuid() {
  ...
  shellspec_syntax_failure_message + 'The $1 does not have setuid flag'
